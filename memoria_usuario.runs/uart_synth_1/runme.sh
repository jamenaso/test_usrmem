...
HD_PWD='C:/Users/jamen/Dropbox/JAIRO MENA/Working/UBA/CSE/Trabajo Final de Carrera/pruebas_unitarias_TFC/memoria_usuario/memoria_usuario.runs/uart_synth_1'
cd "$HD_PWD"
